...
Sur cette étape, l'installation se fait vraiment facilement pour les utilisateurs de Visual Studio 2022+
...
On suit ces conseils;  dotnet build fonctionne, mais il y a le même problème pour le dotnet run. Il y a également toujours un problème de compilation dans le Program.cs. 
...
**Remarque : le tuto du site .io fonctionne très bien, on peut y voir la vitesse de calcul du StrategyBacktest, avec les résultats donnés en temps réél**

Tout se passait bien jusqu'à ce que je tombe sur la ligne de commande : 
...
Clique sur l'icône Source Control dans la barre latérale gauche (icône avec 3 points reliés par des lignes, ou Ctrl+Shift+G)
En haut du panneau, clique sur les "..." (trois points)
Va dans Pull

J'ai donc réussi à pull les modifications faites depuis VS2022. 

Il ne me reste plus qu'à essayer de voir les différences entre l'édition depuis VSCode. 

Il n'y a au final pas beaucoup de différences, et je peux désormais rendre mon texte plus agréable à regarder. 

Modifications faites pour l'instant :
...
>
>Mise en évidence des lignes de code C#
>
